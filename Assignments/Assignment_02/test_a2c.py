...
#   These are the unit tests for functions and classes of assingment2
#   To use this, run: python test_a2c.py

import unittest
from a2c import LinearProbingTS, LinearProbingNoTS

class A2TestCase(unittest.TestCase):
    """These are the test cases for functions and classes of a2"""
    
    def test_init_len_cap(self):
        table1 = LinearProbingNoTS()
        # table2 = LinearProbingTS()

        self.assertEqual(table1.capacity(), 32)
        # self.assertEqual(table2.capacity(), 32)
        self.assertEqual(len(table1), 0)
        # self.assertEqual(len(table2), 0)


        table1 = LinearProbingNoTS(128)
        # table2 = LinearProbingTS(55)

        self.assertEqual(table1.capacity(), 128)
        # self.assertEqual(table2.capacity(), 55)
        self.assertEqual(len(table1), 0)
        # self.assertEqual(len(table2), 0)


    def test_LinearProbingNoTS_insert(self):
    ...
    def test_LinearProbingNoTS_search(self):
    ...
    def test_LinearProbingNoTS_modify(self):
    ...
    def test_LinearProbingNoTS_grow(self):
    ...
    def test_LinearProbingNoTS_remove(self):
        keys = ["apple", "banana", "strawberry", "mango",
                "orange", "lichee", "peach", "pear",
                "grape", "nectarine","blackberry", "clementine",
                "apricot","cantaloupe", "honeydew", "pineapple",
    ...
    def test_LinearProbingTS_insert(self):
    ...
    def test_LinearProbingTS_search(self):
    ...
    def test_LinearProbingTS_modify(self):
    ...
    def test_LinearProbingTS_grow(self):
    ...
    def test_LinearProbingTS_remove(self):
        keys = ["apple", "banana", "strawberry", "mango",
                "orange", "lichee", "peach", "pear",
                "grape", "nectarine","blackberry", "clementine",
                "apricot","cantaloupe", "honeydew", "pineapple",
